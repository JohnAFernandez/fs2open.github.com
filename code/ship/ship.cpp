	...
	for ( i = 0; i < num_primary_banks; i++ ) {		
		...
		if ( pm->n_guns > 0 ) {
			...
			if (needs_target_pos) {
				...
				// the Player object, but in multi it needs the shooting object.  Also, this will need to be added to in the future if you want to apply
				// autoaim to AI, if desired.
