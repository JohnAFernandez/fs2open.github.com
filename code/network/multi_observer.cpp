...
{	
	...
	Net_players[player_num].s_info.kick_timestamp = timestamp(-1);
	Net_players[player_num].s_info.voice_token_timestamp = timestamp(-1);
	Net_players[player_num].s_info.player_collision_timestamp = timestamp(-1);
